...
| GIT-023d: Implement `FetchBranch` — background goroutine; deepen/re-clone; tip-tree-only walk; blob metadata only; branch status transitions | � In Progress | GIT-023b, ~~GIT-023c~~ ✅ |
