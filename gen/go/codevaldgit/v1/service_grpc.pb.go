...
type GitServiceClient interface {
	...
	SearchBlobs(ctx context.Context, in *SearchBlobsRequest, opts ...grpc.CallOption) (*SearchBlobsResponse, error)
}
...
func (c *gitServiceClient) SearchBlobs(ctx context.Context, in *SearchBlobsRequest, opts ...grpc.CallOption) (*SearchBlobsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SearchBlobsResponse)
	err := c.cc.Invoke(ctx, GitService_SearchBlobs_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type GitServiceServer interface {
	...
	// Results are ranked by BM25 relevance and capped by limit (default 20).
	// agency_id is resolved from the service's construction-time scope.
	SearchBlobs(context.Context, *SearchBlobsRequest) (*SearchBlobsResponse, error)
...
func (UnimplementedGitServiceServer) SearchBlobs(context.Context, *SearchBlobsRequest) (*SearchBlobsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method SearchBlobs not implemented")
}
...
func _GitService_SearchBlobs_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SearchBlobsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GitServiceServer).SearchBlobs(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: GitService_SearchBlobs_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GitServiceServer).SearchBlobs(ctx, req.(*SearchBlobsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var GitService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "SearchBlobs",
			Handler:    _GitService_SearchBlobs_Handler,
		},
	},
